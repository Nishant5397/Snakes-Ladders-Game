...
public class Player {
 ...
 //           coin.setTranslateY(gameBoard.getYCoordinate(position));
            TranslateTransition move = translatePlayer(),secondMove = null;
            move.play();
            ...
            {
                SequentialTransition seq = new SequentialTransition(move, new PauseTransition(Duration.millis(500)),secondMove);
                seq.play();
            }
        }
    }
